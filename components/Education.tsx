...
const education = [
  {
    ...
    college: "KIET University, Ghaziabad",
    year: "2025 - 2029",
    cgpa: "CGPA: 8.87",
  },
];
    ...
    <section id="education" className="py-20 px-6">
      ...
      <div className="max-w-4xl mx-auto rounded-2xl p-8 bg-white/10 dark:bg-white/5 backdrop-blur-xl border border-white/20 shadow-xl">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-2xl font-bold">{education[0].degree}</h3>
        </div>

        <p>{education[0].college}</p>

        <p className="text-gray-500 mt-2">{education[0].year}</p>

        <p className="mt-3 font-semibold">{education[0].cgpa}</p>
      </div>
    </section>
  );
}